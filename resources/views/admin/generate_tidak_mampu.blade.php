...
<h4 class="mb-3">Generate Surat Tidak Mampu</h4>

<form action="{{ route('admin.final', ['jenis' => 'tidak_mampu', 'id' => $surat->id]) }}" method="POST">
@csrf
...
<div class="surat">
    ...
    <!-- JUDUL -->
    <div class="judul">
        <div class="f16"><b><u>SURAT KETERANGAN TIDAK MAMPU</u></b></div>
        <div class="f14 nomor">
        ...
        <div class="col-6">
            <label class="card p-3 border pilihan-jam">
                <input type="radio" name="mode_jam" value="kerja"
                    class="form-check-input me-2 @error('mode_jam') is-invalid @enderror"
...
<div class="mt-3">
    ...
    <select id="template" class="form-control">
        ...
        <option value="Silakan datang ke kantor kelurahan dengan membawa KTP,KK Dan Surat Pengantar RT/RW.">
...
<div class="mt-4 d-flex justify-content-between align-items-center">
    ...
    <!-- KIRI -->
    <div>
        <a href="{{ route('admin.edit', ['jenis' => 'tidak_mampu', 'id' => $surat->id]) }}" 
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('admin.pdf', ['jenis' => 'tidak_mampu', 'id' => $surat->id]) }}" 
           target="_blank" 
